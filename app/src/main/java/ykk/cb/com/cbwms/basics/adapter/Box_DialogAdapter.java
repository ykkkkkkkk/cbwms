...
public class Box_DialogAdapter extends RecyclerView.Adapter<Box_DialogAdapter.MyViewHolder> {

    private List<Box> datas;//存放数据
    private Activity context;
    private OnItemClickListener2 mClickListener;

    public Box_DialogAdapter(Activity context, List<Box> datas) {
        this.datas = datas;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.ab_box_dialog_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int pos) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            mholder.tv_fnumber.setText(datas.get(pos).getBoxSize());
            mholder.tv_fname.setText(datas.get(pos).getBoxName());
        }
    }
