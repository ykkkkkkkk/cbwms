...
public class Organization_DialogAdapter extends BaseArrayRecyclerAdapter<Organization> {

    private Activity context;
    private MyCallBack callBack;
    private List<Organization> datas;

    public Organization_DialogAdapter(Activity context, List<Organization> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.ab_organization_dialog_item;
    }
