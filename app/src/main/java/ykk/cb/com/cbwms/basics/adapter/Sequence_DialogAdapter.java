...
public class Sequence_DialogAdapter extends RecyclerView.Adapter<Sequence_DialogAdapter.MyViewHolder> {

    private List<String> datas;//存放数据
    private Activity context;
    private OnItemClickListener2 mClickListener;

    public Sequence_DialogAdapter(Activity context, List<String> datas) {
        this.datas = datas;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.ab_sequence_dialog_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int pos) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            mholder.tv_fname.setText(datas.get(pos));
