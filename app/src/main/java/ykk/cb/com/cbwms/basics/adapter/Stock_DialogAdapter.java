...
public class Stock_DialogAdapter extends BaseArrayRecyclerAdapter<Stock> {

    private Activity context;
    private MyCallBack callBack;
    private List<Stock> datas;

    public Stock_DialogAdapter(Activity context, List<Stock> datas) {
        super(datas);
    ...
    @Override
    public void onBindHoder(RecyclerHolder holder, Stock entity, final int pos) {
        // 初始化id
    ...
    public interface MyCallBack {
        void onClick(Stock entity, int position);
    }
