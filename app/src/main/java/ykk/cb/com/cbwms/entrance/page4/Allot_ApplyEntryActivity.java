...
import ykk.cb.com.cbwms.entrance.page4.adapter.Allot_ApplyEntryAdapter;
import ykk.cb.com.cbwms.util.JsonUtil;
import ykk.cb.com.cbwms.util.LogUtil;

public class Allot_ApplyEntryActivity extends BaseActivity {
    ...
    private Allot_ApplyEntryActivity context = this;
    private static final int SUCC1 = 200, UNSUCC1 = 500;
    private OkHttpClient okHttpClient = new OkHttpClient();
    private Allot_ApplyEntryAdapter mAdapter;
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<Allot_ApplyEntryActivity> mActivity;

        public MyHandler(Allot_ApplyEntryActivity activity) {
            mActivity = new WeakReference<Allot_ApplyEntryActivity>(activity);
        }

        public void handleMessage(Message msg) {
            Allot_ApplyEntryActivity m = mActivity.get();
            if (m != null) {
                m.hideLoadDialog();
    ...
    public int setLayoutResID() {
        return R.layout.allot_apply_entry;
    }
    ...
    public void initView() {
        ...
        mAdapter = new Allot_ApplyEntryAdapter(context, listDatas);
    ...
    private void run_okhttpDatas() {
        showLoadDialog("加载中...");
        String mUrl = getURL("stkTransferOut/findStkTransferOutEntryByBillId2");
