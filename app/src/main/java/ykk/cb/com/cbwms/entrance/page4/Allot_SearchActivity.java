 ...
 * 调拨查询界面
 */
public class Allot_SearchActivity extends BaseActivity implements XRecyclerView.LoadingListener {
    ...
    private Allot_SearchActivity context = this;
    ...
    private Allot_SearchAdapter mAdapter;
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<Allot_SearchActivity> mActivity;

        public MyHandler(Allot_SearchActivity activity) {
            mActivity = new WeakReference<Allot_SearchActivity>(activity);
        }

        public void handleMessage(Message msg) {
            final Allot_SearchActivity m = mActivity.get();
            if (m != null) {
                m.hideLoadDialog();
                ...
                switch (msg.what) {
                    ...
                    case SUCC2: // 查询   调拨单 成功
                        List<StkTransferOut> list = JsonUtil.strToList2((String) msg.obj, StkTransferOut.class);
...
//                .connectTimeout(10, TimeUnit.SECONDS) // 设置连接超时时间（默认为10秒）
        ...
        mAdapter = new Allot_SearchAdapter(context, listDatas);
        ...
        mAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseRecyclerAdapter adapter, BaseRecyclerAdapter.RecyclerHolder holder, View view, int pos) {
                StkTransferOut stk = listDatas.get(pos-1);
                Bundle bundle = new Bundle();
                bundle.putInt("stkBillId", stk.getId());
                bundle.putString("billNo", stk.getBillNo());
                show(Allot_SearchEntryActivity.class, bundle);
            }
        });
    ...
    private void run_okhttpDatas() {
        showLoadDialog("加载中...");
        String mUrl = getURL("stkTransferOut/findStkTransferOutListByCount");
        ...
        FormBody formBody = new FormBody.Builder()
                .add("strBusinessType", "1,2") // 业务类型:1、材料按次 2、材料按批 3、成品
