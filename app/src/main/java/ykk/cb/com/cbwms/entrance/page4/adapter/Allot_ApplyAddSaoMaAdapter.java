...
public class Allot_ApplyAddSaoMaAdapter extends BaseArrayRecyclerAdapter<StkTransferOutTemp> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Allot_ApplyAddSaoMaAdapter(Activity context, List<StkTransferOutTemp> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.allot_apply_add_saoma_item;
    }
