...
public class Allot_PickingListFragment2Adapter extends BaseArrayRecyclerAdapter<StkTransferOutEntry> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Allot_PickingListFragment2Adapter(Activity context, List<StkTransferOutEntry> datas) {
        super(datas);
