 ...
 * 报工查询界面
 */
public class Prod_Wage_Search_Fragment3 extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    private Prod_Wage_Search_Fragment3 context = this;
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<Prod_Wage_Search_Fragment3> mActivity;

        public MyHandler(Prod_Wage_Search_Fragment3 activity) {
            mActivity = new WeakReference<Prod_Wage_Search_Fragment3>(activity);
        }

        public void handleMessage(Message msg) {
            Prod_Wage_Search_Fragment3 m = mActivity.get();
            if (m != null) {
                m.hideLoadDialog();
