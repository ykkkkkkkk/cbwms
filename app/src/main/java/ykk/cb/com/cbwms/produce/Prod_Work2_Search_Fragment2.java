 ...
 * 报工查询界面
 */
public class Prod_Work2_Search_Fragment2 extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    private Prod_Work2_Search_Fragment2 context = this;
    ...
    private Prod_Work2_SearchFragment2Adapter mAdapter;
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<Prod_Work2_Search_Fragment2> mActivity;

        public MyHandler(Prod_Work2_Search_Fragment2 activity) {
            mActivity = new WeakReference<Prod_Work2_Search_Fragment2>(activity);
        }

        public void handleMessage(Message msg) {
            Prod_Work2_Search_Fragment2 m = mActivity.get();
            if (m != null) {
                m.hideLoadDialog();
    ...
    public View setLayoutResID(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.prod_work2_search_fragment2, container, false);
    }
...
//                .connectTimeout(10, TimeUnit.SECONDS) // 设置连接超时时间（默认为10秒）
        ...
        mAdapter = new Prod_Work2_SearchFragment2Adapter(mContext, listDatas, user.getWorkDirector());
        ...
        mAdapter.setCallBack(new Prod_Work2_SearchFragment2Adapter.MyCallBack() {
            @Override
    ...
    private void run_okhttpDatas() {
        showLoadDialog("加载中...");
        String mUrl = getURL("workRecordNew/findWorkRecordNewByPage2");
