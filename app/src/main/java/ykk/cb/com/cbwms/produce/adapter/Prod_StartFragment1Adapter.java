...
public class Prod_StartFragment1Adapter extends BaseArrayRecyclerAdapter<ScanningRecord2> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Prod_StartFragment1Adapter(Activity context, List<ScanningRecord2> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.prod_start_fragment1_item;
    }
