...
public class Prod_Work2_SearchFragment2Adapter extends BaseArrayRecyclerAdapter<WorkRecordNew> {
    ...
    public Prod_Work2_SearchFragment2Adapter(Activity context, List<WorkRecordNew> datas, String workDirector) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.prod_work2_search_fragment2_item;
    }
