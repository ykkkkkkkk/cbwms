...
public class Pur_InMain190403Activity extends BaseActivity {
    ...
    TextView tvTitle;
    private Pur_InMain190403Activity context = this;
...
//    private Customer customer; // 客户
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<Pur_InMain190403Activity> mActivity;

        public MyHandler(Pur_InMain190403Activity activity) {
            mActivity = new WeakReference<Pur_InMain190403Activity>(activity);
        }

        public void handleMessage(Message msg) {
            Pur_InMain190403Activity m = mActivity.get();
            if (m != null) {
                m.hideLoadDialog();
