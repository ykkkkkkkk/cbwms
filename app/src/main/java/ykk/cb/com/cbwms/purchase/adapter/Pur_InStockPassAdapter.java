...
public class Pur_InStockPassAdapter extends BaseArrayRecyclerAdapter<PurInStock> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;
    private List<PurInStock> datas;

    public Pur_InStockPassAdapter(Activity context, List<PurInStock> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.pur_instock_pass_item;
    }

    @Override
    public void onBindHoder(RecyclerHolder holder, final PurInStock entity, final int pos) {
        // 初始化id
        ...
        tv_suppName.setText(entity.getSupName());
    ...
    public interface MyCallBack {
        void onClick(PurInStock entity, int position);
    }
