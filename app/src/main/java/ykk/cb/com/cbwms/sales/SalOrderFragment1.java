...
import ykk.cb.com.cbwms.sales.adapter.Sal_SelOrderAdapter;
...
public class SalOrderFragment1 extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public SalOrderFragment1() {}

    private SalOrderFragment1 mFragment = this;
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<SalOrderFragment1> mFrag;

        public MyHandler(SalOrderFragment1 activity) {
            mFrag = new WeakReference<SalOrderFragment1>(activity);
        }

        public void handleMessage(Message msg) {
            SalOrderFragment1 m = mFrag.get();
            if (m != null) {
                m.hideLoadDialog();
