...
public class Sal_BoxFragment1Adapter extends BaseArrayRecyclerAdapter<MaterialBinningRecord> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Sal_BoxFragment1Adapter(Activity context, List<MaterialBinningRecord> datas) {
        super(datas);
