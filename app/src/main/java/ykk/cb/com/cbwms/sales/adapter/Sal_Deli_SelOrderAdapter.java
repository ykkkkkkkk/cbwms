...
public class Sal_Deli_SelOrderAdapter extends BaseArrayRecyclerAdapter<DeliOrder> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;
    private List<DeliOrder> datas;

    public Sal_Deli_SelOrderAdapter(Activity context, List<DeliOrder> datas) {
        super(datas);
    ...
    @Override
    public void onBindHoder(RecyclerHolder holder, DeliOrder entity, final int pos) {
            // 初始化id
            ...
            tv_date.setText(entity.getDeliDate());
...
//                            }
    ...
    public interface MyCallBack {
        void onClick(DeliOrder entity, int position);
    }
