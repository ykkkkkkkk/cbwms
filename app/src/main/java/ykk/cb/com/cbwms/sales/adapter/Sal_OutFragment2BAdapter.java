...
public class Sal_OutFragment2BAdapter extends BaseArrayRecyclerAdapter<ScanningRecord2> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Sal_OutFragment2BAdapter(Activity context, List<ScanningRecord2> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.sal_out_fragment2b_item;
    }
