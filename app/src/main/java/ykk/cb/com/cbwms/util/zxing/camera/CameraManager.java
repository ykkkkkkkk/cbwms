...
package ykk.cb.com.cbwms.util.zxing.camera;
...
public final class CameraManager {
     ...
     */
//	public synchronized Rect getFramingRect() { // 原生的，不会全部适配屏幕
//		if (framingRect == null) {
//			if (camera == null) {
//				return null;
//			}
...
//		return framingRect;
//	}
    public synchronized Rect getFramingRect() { // 我为了适配不同的屏幕大小将代码改成了
        if (framingRect == null) {
            if (camera == null) {
                return null;
            }
